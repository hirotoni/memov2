...
func New(c *config.TomlConfig, e interfaces.Editor) (*BrowseModel, error) {
	...
	l.AdditionalShortHelpKeys = func() []key.Binding {
		return []key.Binding{
			...
			key.NewBinding(key.WithKeys("N"), key.WithHelp("N", "new memo")),
	...
	repo := memo.NewMemo(m.config.MemosDir())
	err = repo.TidyMemos()
	if err != nil {
