...
func (h *MarkdownHandler) HeadingBlockByHeading(source []byte, heading Heading) (*models.HeadingBlock, error) {
...
func (h *MarkdownHandler) TopLevelBodyContent(source []byte) *models.HeadingBlock {
	reader := text.NewReader(source)
	doc := h.md.Parser().Parse(reader)
