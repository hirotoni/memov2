...
type fileRepo interface {
	TodosTemplate(date time.Time) (models.FileInterface, error)
	FindTodosFileByDate(date time.Time) (models.FileInterface, error)
	Save(file models.FileInterface, truncate bool) error
}
...
func (r *fileRepoImpl) TodosTemplate(date time.Time) (models.FileInterface, error) {
...
func (r *fileRepoImpl) FindTodosFileByDate(date time.Time) (models.FileInterface, error) {
	f, err := models.NewTodosFile(date)
	if err != nil {
		return nil, err
	}
...
func (r *fileRepoImpl) Save(file models.FileInterface, truncate bool) error {
